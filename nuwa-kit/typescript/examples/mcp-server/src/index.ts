...
async function main() {
  ...
  server.freeTool({
    ...
    parameters: {
      longitude: z.number().describe('The longitude of the city to get the weather for'),
      latitude: z.number().describe('The latitude of the city to get the weather for'),
    },
