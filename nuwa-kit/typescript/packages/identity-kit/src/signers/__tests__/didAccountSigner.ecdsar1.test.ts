...
class MockEcdsaR1Signer implements SignerInterface {
  ...
  private publicKey = new Uint8Array([
    0x02, 0x58, 0xa6, 0x18, 0x06, 0x68, 0x14, 0x09, 0x8f, 0x8d, 0xdb, 0x3c,
    0xbd, 0xe7, 0x38, 0x38, 0xb5, 0x90, 0x28, 0xd8, 0x43, 0x95, 0x80, 0x31,
    0xe5, 0x0b, 0xe0, 0xa5, 0xf4, 0xb0, 0xa9, 0x79, 0x6d
  ]);
