...
import googlePricingConfig from './google-pricing.json' with { type: 'json' };
...
export class PricingConfigLoader {
  ...
  loadConfig(): PricingConfig {
    ...
    try {
      ...
      const configs = [
        ...
        { name: 'Google', config: googlePricingConfig as PricingConfig },
      ];
  ...
  getProviderConfigs(): Record<string, PricingConfig> {
    ...
    return {
      ...
      google: googlePricingConfig as PricingConfig,
    };
  }
