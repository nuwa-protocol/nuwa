...
import { useCustodianService } from '../hooks/useCustodianService';
import { AgentDIDInstructions } from '../components/AgentDIDInstructions';
import { AuthMethodSelector } from '../components/AuthMethodSelector';
import { DIDCreationStatus } from '../components/DIDCreationStatus';
import { DIDDisplayCard } from '../components/DIDDisplayCard';
import type { AuthMethod, CADOPMintRequest, DIDCreationStatus as DIDStatus } from '../services/custodianService';
...
export const CreateAgentDIDPage: React.FC = () => {
  ...
  const handleStartCreation = async () => {
    ...
    try {
      ...
      const request: CADOPMintRequest = {
        idToken,
