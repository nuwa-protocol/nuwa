...
- ✅ Simple Git or Docker image integration deployment
...
Context7 example: `https://raw.githubusercontent.com/nuwa-protocol/nuwa-caps/refs/heads/main/mcp-proxy-config/context7-mcp.yaml`
</ResponseField>
...
1. **Build a Cap**: Use [CapStudio](/build-caps/quickstart) to create a Cap that uses your MCP proxy
