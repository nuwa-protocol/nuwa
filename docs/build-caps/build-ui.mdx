...
For all props and return types, see: /sdk/ui-kit#nuwaprovider and /sdk/ui-kit#usenuwa
...
export default function App() {
  return (
    <NuwaProvider autoHeight onConnected={() => console.log('Nuwa connected')} onError={console.error}>
      <MyCapUI />
    </NuwaProvider>
  );
}
